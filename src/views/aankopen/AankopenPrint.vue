  ...
  <div class="factuur-content">
      ...
      <div class="column">
        ...
        <div class="columns">
          ...
          <div class="column">
            <p class="factuur-text">{{ aankoop.klant_naam }}</p>
            <p class="factuur-text">
              {{ leveradres.straat }}, {{ leveradres.huisnummer }}
              {{ leveradres.bus }}
            </p>
            <p class="factuur-text">
              {{ leveradres.postcode }} {{ leveradres.gemeente }}
              {{ leveradres.land }}
            </p>
          </div>
        </div>
    ...
    <table class="content-table-style">
      ...
      <tr
        ...
        v-for="item in aankoop.artikels"
        :key="item.id"
      >
...
export default {
  ...
  mounted() {
    AankopenController.getPrintPreData(
      this,
    ...
    calculateBtw() {
      if (this.aankoop.btw_prijs) {
        return `${UtilsFactory.roundNumber(
          parseFloat(this.aankoop.btw_prijs) *
            parseFloat(this.aankoop.subtotaal)
        )}`;
      }
      return "...";
    },
